...
const GOOGLEAI_MAX_CONTEXT = config.maxContextTokensGoogleAI;
...
export const validateContextSize: RequestPreprocessor = async (req) => {
  ...
  } else if (model.match(/(openai\/|google\/|anthropic\/|meta-llama\/|microsoft\/|amazon\/|nvidia\/|mistralai\/|cohere\/|x-ai\/|perplexity\/|deepseek\/|qwen\/|alibaba\/|baidu\/|tencent\/|bytedance-seed\/|xiaomi\/|minimax\/|moonshotai\/|z-ai\/|allenai\/|nousresearch\/|ibm-granite\/|liquid\/|arcee-ai\/|ai21\/|inflection\/|thudm\/)/)) {
    modelMax = 2000000;
  } else {
