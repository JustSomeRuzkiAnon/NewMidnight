...
export const OPENROUTER_FAMILY_MAP: Record<string, OpenRouterModelFamily> = {
  "openai/": "OpRout_OpenAI",
  "anthropic/": "OpRout_Anthropic",
  "google/": "OpRout_Google_AI_Studio",
  "x-ai/": "OpRout_XAI",
  "amazon/": "OpRout_Amazon",
  "cohere/": "OpRout_Cohere",
  "^deepseek/": "OpRout_Deepseek",
  "meta-llama/": "OpRout_Meta",
  "mistralai/": "OpRout_Mistral",
  "qwen/": "OpRout_Qwen",
  "z-ai/": "OpRout_ZAI",
  "nvidia/": "OpRout_Nvidia",
  "moonshotai/": "OpRout_MoonshotAI",
  ".*": "OpRout_Other"
};
...
export const MODEL_FAMILY_SERVICE: {
  ...
  "gemini-images":"google-ai",
  "pro-preview": "google-ai",
  "flash-preview": "google-ai",
  "mistral-tiny": "mistral-ai",
  "mistral-small": "mistral-ai",
  "mistral-medium": "mistral-ai",
  "mistral-large": "mistral-ai",
  "openrouter": "openrouter",
  "OpRout_OpenAI": "openrouter",
  "OpRout_Anthropic": "openrouter",
  "OpRout_Google_AI_Studio": "openrouter",
  "OpRout_XAI": "openrouter",
  "OpRout_Amazon": "openrouter",
  "OpRout_Cohere": "openrouter",
  "OpRout_Deepseek": "openrouter",
  "OpRout_Meta": "openrouter",
  "OpRout_Mistral": "openrouter",
  "OpRout_Qwen": "openrouter",
  "OpRout_ZAI": "openrouter",
  "OpRout_Nvidia": "openrouter",
...
export function getGoogleAIModelFamily(model: string): GoogleAIModelFamily {
  ...
  if (m.includes("ultra") && !m.includes("imagen")) {
    return "gemini-ultra";
  }
  ...
  if (m.includes("pro-preview")) {
    return "pro-preview";
  }

  if (m.includes("flash-preview")) {
