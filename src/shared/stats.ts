...
const MODEL_PRICING: Record<ModelFamily, { input: number; output: number } | undefined> = {
  ...
  "gemini-images": { input: 25.00, output: 75.00 }, // Estimated based on Gemini Pro (5-10x) and character to token conversion. Official per-token pricing needed.
  "flash-preview": { input: 0.15, output: 0.60 }, // Updated to Gemini 2.5 Flash Preview (text input, non-thinking output)
  "pro-preview": { input: 1.25, output: 10.00 }, // Updated to Gemini 2.5 Pro Preview (<=200k tokens)
  ...
  "openrouter": { input: 3.00, output: 9 },
  "OpRout_OpenAI": { input: 0, output: 0 },
  "OpRout_Anthropic": { input: 0, output: 0 },
  "OpRout_Google_AI_Studio": { input: 0, output: 0 },
  "OpRout_XAI": { input: 0, output: 0 },
  "OpRout_Amazon": { input: 0, output: 0 },
  "OpRout_Cohere": { input: 0, output: 0 },
  "OpRout_Deepseek": { input: 0, output: 0 },
  "OpRout_Meta": { input: 0, output: 0 },
  "OpRout_Mistral": { input: 0, output: 0 },
  "OpRout_Qwen": { input: 0, output: 0 },
  "OpRout_ZAI": { input: 0, output: 0 },
  "OpRout_Nvidia": { input: 0, output: 0 },
  "OpRout_MoonshotAI": { input: 0, output: 0 },
  "OpRout_Other": { input: 0, output: 0 },
};
