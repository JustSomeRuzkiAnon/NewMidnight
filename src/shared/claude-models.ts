...
export const claudeModels: ClaudeModelMapping[] = [
  ...
  { awsId: "anthropic.claude-opus-4-5-20251101-v1:0", anthropicId: "claude-opus-4-5-latest", displayName: "Claude 4.5 Opus" },
  { awsId: "anthropic.claude-opus-4-5-20251101-v1:0", anthropicId: "claude-opus-4-5", displayName: "Claude 4.5 Opus (Latest)" },
];
