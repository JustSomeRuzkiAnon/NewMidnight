...
export class GlmZaiCodingKeyChecker {
  private log = logger.child({ module: "key-checker", service: "glm-zai-coding" });

  constructor(private readonly update: (hash: string, key: Partial<GlmZaiCodingKey>) => void) {}
