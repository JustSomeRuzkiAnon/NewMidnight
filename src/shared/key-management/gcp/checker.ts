  ...
  protected async testKeyOrFail(key: GcpKey) {
    ...
    if (isInitialCheck) {
      ...
      checks = [
        ...
        this.invokeModel("claude-opus-4-5@20251101", key, true),
      ];

      const [sonnet, haiku, opus3, opus41, opus45, sonnet35, sonnet45, haiku45] = await Promise.all(checks);

      this.log.debug(
        { key: key.hash, sonnet, haiku, opus3, opus41, opus45, sonnet35, sonnet45, haiku45 },
      ...
      if (opus3 || opus41 || opus45) families.push("gcp-claude-opus");
